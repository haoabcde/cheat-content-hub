...
输出写到**你的内容项目** `videos/<...>/report.md`（或 cheat-retro 传入的 artifact folder；`cheat-retro` 读这个文件 → 摘要写到 prediction 复盘段）。
...
# 抓特定视频
python "$ADAPTER/review.py" video <aweme_id> <artifact_folder>/script.md
