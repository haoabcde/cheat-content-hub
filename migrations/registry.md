...
| 1.4 | 1.5 | **BREAKING** | [1.4-to-1.5.md](1.4-to-1.5.md) | 多格式扩展：新增 `default_format` 字段和 `formats` 对象，每个格式独立维护 `rubric_version`、`calibration_samples`、`pending_retros` 等。老用户的顶层字段迁移到 `formats.video` 下。新增公众号和小红书 rubric |
